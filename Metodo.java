...
public abstract class Metodo {
	...
	public static int nullFinder(Object[] arr) {	//Encuentra la primera posición nula de un array (solo funciona con objetos, asi que usar wrappers)
		int i;
	...
	public static void printArray(Object[] arr) {	//Imprime arrays de objetos (usar wrappers para primitivos)
